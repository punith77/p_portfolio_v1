        ...
        <div className='skill-wrapper'>
          <div className='about-me'>
            ...
            <div className='skill-about'>
              ...
              I'm the Senior Developer for{" "}
              <a
                className='highlight'
                href='http://www.shaw.ca'
                target='_blank'
              ...
              <br></br>creating intuitive, dynamic user experiences.
              <br />
              <Link to='/contact' className='page-link'>
                <span dest='contact'>Let's make something special.</span>
              </Link>
            </div>
          </div>
